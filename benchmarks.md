...
The benchmark results here while a bit dated. For a more up to date benchmark, see the [Microbenchmarks site](https://julialang.github.io/Microbenchmarks/dev/).
