...
* Bartłomiej Łukaszuk, [Julia. Projects from a Recreational Programmer's Drawer](https://b-lukaszuk.github.io/J_PRPD_eng/), available freely under [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/), 2026.
...
* Luiz A. N. Lorena, Luiz H. N. Lorena, and Antônio A. Chaves. [Introduction to Integer Programming and Applications with Julia](https://luiz-lorena.github.io/intro-ilp-with-julia/), available freely under [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/), July 2026.
