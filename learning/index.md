...
<!--
 ...
 <div class="container pt-sm-2">
   ...
   <div class="row">
     ...
     <div class="col-lg-4 col-md-6 feature">
       <h3>The Manual</h3>
       <p>Want to just give it a shot and dive right into the Julia documentation? Check out the <a href="https://docs.julialang.org/en/v1/manual/getting-started/">getting started guide</a>.
       </p>
     </div>
