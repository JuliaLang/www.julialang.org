...
![GitHub PR comment triggering DiffEqBot benchmark](https://i.imgur.com/YoigTvy.png)
...
![DiffEqBot checking for pending jobs](https://i.imgur.com/lWS8i7X.jpg)
...
![DiffEqBot generating Gitlab CI configuration](https://i.imgur.com/ORRPWx7.jpg)
...
![Gitlab CI detecting the benchmark branch](https://i.imgur.com/vYvx4Ta.jpg)
...
![DiffEqBot submitting benchmark report](https://i.imgur.com/49pIrAe.jpg)

6. Then it makes a comment on the same PR notifying that the job is complete and report is generated.

![DiffEqBot commenting that the benchmark report is complete](https://i.imgur.com/XN8sQMo.png)
