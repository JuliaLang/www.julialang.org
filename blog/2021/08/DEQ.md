...
pendulum using Hamiltonian equations, one could simply train a neural network to represent
...
modelling technique, especially when we only observe input and output data of the system
