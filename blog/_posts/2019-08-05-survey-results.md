...
Among Julia users and developers, the \#2 most-used programming language (after Julia, of course) is Python, and the \#3 most-used languages are Bash/Shell/PowerShell (combined). MATLAB, C++, C, R, SQL, JavaScript and Java are further down the list.

Python is the second-favorite language among Julia users and developers (again, after Julia, of course), followed by C. R, MATLAB, C++, Bash/Shell/PowerShell, SQL, JavaScript and Java follow behind.

If not using Julia, most Julia users and developers say they would be using Python, followed by C/C++/C\# (combined), MATLAB and R.
