...
First, download the `.tar.gz` file from the [downloads page](index.html). You need to extract this file to a suitable location. To extract the file, you can use the following command:
