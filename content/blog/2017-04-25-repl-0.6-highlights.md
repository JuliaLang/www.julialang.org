...
Among other features, the REPL provides code completion, history with reverse search, and a rich set of customizable key bindings. (See the [Interacting with Julia](https://docs.julialang.org/en/v1/manual/getting-started/) part of the manual for the REPL documentation.)
