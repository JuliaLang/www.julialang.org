...
<!--
 ...
 <div class="container pt-sm-2">
   ...
   <p>Please take a moment to read the <a href="/community/standards/">Julia Community Standards</a>. We expect that your participation in any Julia related forum, online or offline, respects these standards. The Julia Community is committed to continuing to foster an inclusive and diverse culture. Read more about how we are doing this on our <a href="/diversity/">diversity page</a>.
   </p>
   <br>
</div>
...
<!--
 ...
 <div class="container-fluid alt-color packages">
   ...
   <div class="row">
     ...
     <div class="col-lg-4 col-md-6 feature">
       <h3>Chat</h3>
       <p>For casual conversations, we have an <a href="https://julialang.org/slack/">official Julia Slack</a>. As an open source alternative to Slack and home to some Julia sub-communities, we also have <a href="https://julialang.zulipchat.com/register/">Zulip</a> and <a href="https://discord.gg/mm2kYjB">Discord server</a>.
       </p>
     </div>
     <!-- 4 -->
     <div class="col-lg-4 col-md-6 feature">
